         ...
         <div>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:Label ID="Label1" runat="server" BorderStyle="None" Font-Bold="True" Font-Size="13pt" Font-Underline="True" Text="Temas "></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3">
                    ...
                    <td class="auto-style12">
                        <asp:Label  runat="server" Text="ID del Tema: "></asp:Label>
                        <asp:TextBox ID="txtID_Tema" runat="server" Width="97px"></asp:TextBox>&nbsp
                        <asp:Label  runat="server" Text="Categoria: "></asp:Label>
                        <asp:DropDownList ID="ddlCategoria" runat="server" AutoPostBack="True" Width="183px" OnSelectedIndexChanged="ddlCategoria_SelectedIndexChanged">
                        </asp:DropDownList>&nbsp&nbsp
                        <asp:Label  runat="server" Text="Curso: "></asp:Label>
                        <asp:DropDownList ID="ddlCurso" runat="server" AutoPostBack="True" Width="183px">
                ...
                <tr>
                    ...
                    <td class="auto-style11" rowspan="5">
                        <asp:GridView ID="gdwTemas" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
