<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Privilegios.aspx.cs" Inherits="Privilegios" %>
        ...
        <div>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:Label ID="Label1" runat="server" BorderStyle="None" Font-Bold="True" Font-Size="12pt" Font-Underline="True" Text="Privilegios"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3"> 
                    ...
                    <td class="auto-style6">
                        <asp:Label   runat="server" Text="ID del Privilegio:" Font-Bold="True"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtID_Privilegio" runat="server" Width="127px"></asp:TextBox>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style5">
                        <asp:Label  runat="server" Text="Nombre del Privilegio:" Font-Bold="True"></asp:Label>
                    </td>
                    <td class="auto-style5" colspan="2">
                        <asp:TextBox ID="txtNombre_privilegio" runat="server" Width="391px"></asp:TextBox><br />
                ...
                <tr>
                    ...
                    <td colspan="3" class="auto-style7" rowspan="4">
                        <asp:GridView ID="gdwPrivilegios" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                ...
                <tr>
                    <td class="auto-style3">
                         <asp:Button ID="btnPrivilegios" runat="server" BackColor="#0E176B" BorderStyle="Solid" Font-Bold="False" Font-Names="Roboto" Font-Size="12pt" ForeColor="White" Height="60px" Text="Privilegios" Width="286px" BorderColor="Aqua" BorderWidth="1px" OnClick="Privilegio_Click" />
                      </td>
                </tr>
                <tr>
                    <td class="auto-style3">
